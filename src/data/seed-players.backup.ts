...
function p(
  ...
  const gamesStarted = gs ?? estimatePitcherStarts(wins, so)
  const games = g ?? gamesStarted
  return {
    id,
    personId: personIdFromName(name),
    name,
    ...
    stats: {
      ...
      gs: gamesStarted,
      g: games,
      reliefGames: Math.max(0, games - gamesStarted),
    },
    ratings,
  }
}
...
export const SEED_PLAYERS_BACKUP: Player[] = [
  ...
  p('ruth-p', 'Babe Ruth', 'red-sox', 'Red Sox', '1910s', ['SP'], '2.19', '1.05', 133, 89, pitcherRatings(92, 90, 85, 88, 82)),
  ...
  p('ford-61', 'Whitey Ford', 'yankees', 'Yankees', '1960s', ['SP'], '2.75', '1.22', 1569, 236, pitcherRatings(90, 88, 82, 90, 85)),
  ...
  p('rivera-03', 'Mariano Rivera', 'yankees', 'Yankees', '1990s', ['RP'], '2.21', '1.00', 1173, 82, pitcherRatings(96, 98, 88, 75, 80), 0, 1000),
  ...
  p('martinez-04', 'Pedro Martinez', 'red-sox', 'Red Sox', '1990s', ['SP'], '2.52', '1.05', 2194, 117, pitcherRatings(94, 95, 95, 82, 88)),
  ...
  p('koufax-66', 'Sandy Koufax', 'dodgers', 'Dodgers', '1960s', ['SP'], '2.76', '1.11', 2396, 165, pitcherRatings(91, 92, 94, 85, 82)),
  ...
  p('kershaw-14', 'Clayton Kershaw', 'dodgers', 'Dodgers', '2010s', ['SP'], '2.48', '1.02', 2100, 210, pitcherRatings(93, 94, 90, 88, 86)),
  ...
  p('marichal-69', 'Juan Marichal', 'giants', 'Giants', '1960s', ['SP'], '2.89', '1.18', 2303, 243, pitcherRatings(88, 86, 88, 88, 85)),

  h('musial-63', 'Stan Musial', 'cardinals', 'Cardinals', '1950s', ['LF', '1B'], '.331', 475, 1951, 78, '.976', hitterRatings(92, 90, 70, 94, 95)),
  p('gibson-68', 'Bob Gibson', 'cardinals', 'Cardinals', '1960s', ['SP'], '2.91', '1.19', 3117, 251, pitcherRatings(88, 85, 92, 88, 90)),
  ...
  p('brown-98', 'Mordecai Brown', 'cubs', 'Cubs', '1920s', ['SP'], '2.06', '1.04', 1372, 239, pitcherRatings(95, 92, 80, 88, 78)),
  ...
  p('smoltz-99', 'John Smoltz', 'braves', 'Braves', '1990s', ['SP', 'RP'], '3.33', '1.22', 3084, 213, pitcherRatings(82, 84, 90, 85, 85), 250, 400),

  p('seaver-75', 'Tom Seaver', 'mets', 'Mets', '1970s', ['SP'], '2.86', '1.12', 3640, 311, pitcherRatings(90, 90, 95, 92, 90)),
  ...
  p('degarom-22', 'Jacob deGrom', 'mets', 'Mets', '2010s', ['SP'], '2.52', '0.99', 1600, 87, pitcherRatings(94, 96, 92, 78, 80)),

  h('schmidt-89', 'Mike Schmidt', 'phillies', 'Phillies', '1980s', ['3B'], '.267', 548, 1595, 174, '.885', hitterRatings(75, 96, 65, 90, 90)),
  p('carlton-84', 'Steve Carlton', 'phillies', 'Phillies', '1980s', ['SP'], '3.22', '1.25', 4136, 329, pitcherRatings(85, 80, 95, 90, 92)),
  ...
  p('nolan-75', 'Nolan Ryan', 'astros', 'Astros', '1980s', ['SP'], '3.19', '1.25', 5714, 324, pitcherRatings(84, 80, 99, 88, 92)),
  ...
  p('verlander-19', 'Justin Verlander', 'tigers', 'Tigers', '2010s', ['SP'], '3.24', '1.19', 3100, 257, pitcherRatings(84, 86, 90, 88, 88)),
  ...
  p('hunter-74', 'Catfish Hunter', 'athletics', 'Athletics', '1970s', ['SP'], '3.26', '1.20', 2012, 224, pitcherRatings(82, 82, 82, 85, 85)),
  ...
  p('palmer-85', 'Jim Palmer', 'orioles', 'Orioles', '1970s', ['SP'], '2.86', '1.18', 2212, 268, pitcherRatings(90, 88, 85, 88, 88)),
  ...
  p('johnson-01', 'Randy Johnson', 'mariners', 'Mariners', '1990s', ['SP'], '3.29', '1.17', 4135, 303, pitcherRatings(85, 88, 96, 90, 90)),
  ...
  p('clemens-98', 'Roger Clemens', 'astros', 'Astros', '1990s', ['SP'], '3.12', '1.17', 4672, 354, pitcherRatings(86, 88, 94, 92, 90)),

  p('ryan-tex', 'Nolan Ryan', 'rangers', 'Rangers', '1990s', ['SP'], '3.19', '1.25', 5714, 324, pitcherRatings(84, 80, 99, 88, 92)),
  ...
  p('halladay-12', 'Roy Halladay', 'blue-jays', 'Blue Jays', '2000s', ['SP'], '3.38', '1.18', 2117, 203, pitcherRatings(82, 86, 85, 85, 88)),
  ...
  p('hoffman-08', 'Trevor Hoffman', 'padres', 'Padres', '1990s', ['RP'], '2.87', '1.04', 1133, 0, pitcherRatings(90, 92, 82, 60, 75), 0, 900),

  p('strasburg-19', 'Stephen Strasburg', 'nationals', 'Nationals', '2010s', ['SP'], '3.30', '1.08', 1713, 89, pitcherRatings(82, 90, 88, 72, 78)),
  ...
  p('buehrle-12', 'Mark Buehrle', 'white-sox', 'White Sox', '2000s', ['SP'], '3.82', '1.25', 1850, 214, pitcherRatings(78, 82, 80, 82, 85)),
  ...
  p('feller-54', 'Bob Feller', 'guardians', 'Indians', '1940s', ['SP'], '3.25', '1.32', 2581, 266, pitcherRatings(88, 78, 90, 88, 88)),
  ...
  p('saberhagen-89', 'Bret Saberhagen', 'royals', 'Royals', '1980s', ['SP'], '3.34', '1.18', 1715, 167, pitcherRatings(85, 88, 85, 82, 82)),

  h('carew-77', 'Rod Carew', 'twins', 'Twins', '1970s', ['1B'], '.328', 92, 1015, 353, '.822', hitterRatings(95, 72, 85, 85, 86)),
  p('viola-91', 'Frank Viola', 'twins', 'Twins', '1980s', ['SP'], '3.90', '1.28', 1652, 176, pitcherRatings(78, 80, 82, 82, 80)),

  h('trout-20', 'Mike Trout', 'angels', 'Angels', '2010s', ['CF'], '.298', 350, 900, 220, '.990', hitterRatings(88, 92, 90, 90, 96)),
  p('weaver-14', 'Jered Weaver', 'angels', 'Angels', '2010s', ['SP'], '3.63', '1.20', 2100, 150, pitcherRatings(82, 86, 85, 78, 82)),

  h('stanton-17', 'Giancarlo Stanton', 'marlins', 'Marlins', '2010s', ['RF'], '.268', 350, 900, 10, '.920', hitterRatings(75, 96, 55, 88, 90)),
  p('johnson-04', 'Josh Johnson', 'marlins', 'Marlins', '2000s', ['SP'], '3.40', '1.25', 1200, 80, pitcherRatings(82, 84, 85, 72, 78)),

  h('yelich-19', 'Christian Yelich', 'brewers', 'Brewers', '2010s', ['LF'], '.290', 180, 650, 160, '.850', hitterRatings(85, 82, 88, 82, 86)),
  p('burnes-23', 'Corbin Burnes', 'brewers', 'Brewers', '2020s', ['SP'], '3.20', '1.05', 900, 60, pitcherRatings(88, 92, 88, 70, 75)),

  h('walker-97', 'Larry Walker', 'rockies', 'Rockies', '1990s', ['RF'], '.313', 383, 1311, 230, '.965', hitterRatings(88, 90, 82, 90, 92)),
  p('jennings-06', 'Jason Jennings', 'rockies', 'Rockies', '2000s', ['SP'], '4.50', '1.40', 600, 45, pitcherRatings(70, 72, 72, 65, 70)),

  h('goldschmidt-23', 'Paul Goldschmidt', 'diamondbacks', 'Diamondbacks', '2010s', ['1B'], '.290', 320, 1000, 120, '.900', hitterRatings(85, 88, 65, 88, 88)),
  p('johnson-01-randy', 'Randy Johnson', 'diamondbacks', 'Diamondbacks', '2000s', ['SP'], '3.29', '1.17', 4135, 303, pitcherRatings(85, 88, 96, 90, 90)),

  p('price-18', 'David Price', 'rays', 'Rays', '2010s', ['SP'], '3.42', '1.20', 1800, 140, pitcherRatings(82, 86, 88, 82, 85)),
  h('longoria-16', 'Evan Longoria', 'rays', 'Rays', '2010s', ['3B'], '.267', 340, 1100, 20, '.820', hitterRatings(78, 88, 55, 85, 82)),
  p('snell-23', 'Blake Snell', 'rays', 'Rays', '2020s', ['SP'], '3.20', '1.10', 1200, 80, pitcherRatings(88, 90, 88, 72, 78)),
]
