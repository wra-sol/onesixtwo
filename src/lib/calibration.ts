 ...
 * - Perfect seasons remain rare and require near-perfect lineups.
...
/** Team score above which a perfect season is theoretically possible. */
export const PERFECT_SEASON_THRESHOLD = 96

/** Minimum team score required for any perfect-season outcome. */
export const PERFECT_SEASON_MIN_SCORE = 94
...
> = {
  ...
  elite: {
    tierLabel: 'Dynasty',
    winBand: { min: 105, max: 155 },
    maxRerollSwing: 18,
    canReachPerfect: false,
  },
  nearPerfect: {
    tierLabel: 'Dynasty',
    winBand: { min: 120, max: 162 },
    maxRerollSwing: 18,
